...
export type StorageHash =
  StorageHashBase<'aa89397ea901e0fb683d1004884ce9f066b66d2870ed0ad013f098d7d9957d34'>;
export type ExecutionHash =
  ExecutionHashBase<'aebd8243d5bb9f815473e0d6d9d4715ecc8702b95afd47a77c57b0e63745da78'>;
...
export namespace Models {
  ...
  export type public_Course = {
    ...
    sessions: public_AttendanceSession[];
    slot: public_Slot;
    readonly [RelationKeys]?: 'enrollments' | 'sessions' | 'slot';
  };
  export type public_Slot = {
    ...
    sessions: public_AttendanceSession[];
    readonly [RelationKeys]?: 'courses' | 'sessions';
  };
  ...
  export type public_AttendanceSession = {
    ...
    slot: public_Slot;
    teacher: public_User;
    readonly [RelationKeys]?: 'course' | 'records' | 'slot' | 'teacher';
  };
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly attendanceSession: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['courseId', 'slotId', 'date'] }];
              indexes: readonly [
                {
                ...
                {
                  readonly name: 'attendanceSession_slotId_idx_4d7c6bc9';
                  readonly prefix: 'attendanceSession_slotId_idx';
            ...
            readonly course: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['code', 'slotId'] }];
              indexes: readonly [
                {
                  readonly name: 'course_slotId_idx_4d7c6bc9';
                  readonly prefix: 'course_slotId_idx';
                  readonly columns: readonly ['slotId'];
                  readonly unique: false;
                },
              ];
